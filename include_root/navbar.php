    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto my-2 my-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="dashboard/companyFloated.php">Company</a>
                </li>
                <li class="nav-item">
              ...
              ?>
                <li class="nav-item dropdown">
					...
					<?php }else{?>
						 <a class="dropdown-item dd js-scroll-trigger" href="dashboard/index.php">Dashboard</a>
					<?php }?>
