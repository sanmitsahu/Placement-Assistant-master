    ...
    
    {
        ...
        if(mysqli_num_rows($qrun)>0){
            while($row2=mysqli_fetch_array($qrun)){
                $out2.='	    <div><br><hr style="height:2px;border-width:100%;color:gray;background-color:gray"><div class="input-group control-group after-add-more">							<input type="text" name="already_uploaded_title[]" id="" value="'.$row2['coursettl'].'" class="form-control" placeholder="Title">    </div>                        <div id="error3" name="error3[]" style="color:#f23a3a;padding-left:20px;margin:0px;padding-bottom:0px;padding-top:0px;" ><?php// echo $error2; ?></div>                       <br>					<div class="input-group control-group after-add-more">							<textarea name="already_uploaded_desc[]" id="" class="form-control" placeholder="Description" value="" rows="4" cols="20">'.$row2['coursedsc'].'</textarea>					</div>  <br>				<div class="input-group control-group after-add-more">							View Certificate:  &nbsp;<input type="hidden"  value="'.$row2['coursect'].'" class="form-control" name="already_uploaded[]"><a href="view.php">View</a><button class="btn ovrdbtn btn-outline-danger remove_field_2" type="button"><i class="fa fa-minus" style="font-size:20px"></i></button>                           </div> <div id="error4" name="error4[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div></div>&nbsp;&nbsp;'; //add input box
        }
        }	
            }
...
<div class="row justify-content-xl-center">
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation cst-bclass" id ="qwerq" enctype="multipart/form-data"  novalidate>
              ...
              <hr style="height:2px;border-width:0;color:gray;background-color:gray">
		        ...
		        <div class="form-group">
					<div class="col-md-6 col-sm-6 col-xs-6 col-md-offset-3 col-sm-offset-3 col-xs-offset-3 text-center">
						<button type="button" class="btn btn-outline-primary btn-block submit" name="submit_skills" id="submit_skills" value="submit">Submit</button>
					</div>
				</div>
          </form>
