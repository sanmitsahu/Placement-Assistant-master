    ...
    
    {
        ...
        if(mysqli_num_rows($qrun)>0){
            while($row2=mysqli_fetch_array($qrun)){
                ...
                $out2.='<div class="col-md-9 col-sm-9 col-xs-9"><br><hr style="height:2px;border-width:50%;color:gray;background-color:gray"><div class="input-group control-group after-add-more"><label for="itp">Internship type:&nbsp</label><select class="form-control" id="itp" class="itp" name="itp[]"><option value="In-House" <?php if($temp=="In-House") { echo htmlspecialchars("selected");} ?>In-House</option><option value="External" <?php if($temp=="External") { echo htmlspecialchars("selected");} ?>  External</option></select></div><br><div class="input-group control-group after-add-more"><input type="ittl" name="ittl[]" value="'.$row2['ittl'].'" id="ittl" class="form-control" placeholder="Title"></div> <div id="error2" name="error2[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?> </div><br><div class="input-group control-group after-add-more"><textarea value="'.$row2['idsc'].'" name="idsc[]" id="idsc" class="form-control" placeholder="Description" rows="4" cols="20">'.$row2['idsc'].'</textarea></div><br><div class="input-group control-group after-add-more">Upload Certificate:  &nbsp;<input type="file" id="ict" value="'.$row2['ict'].'"  name="ict[]" class="form-control" name="mytext3[]">&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn ovrdbtn btn-outline-danger remove_field_2" type="button"><i class="fa fa-minus" style="font-size:20px"></i></button></div><div id="error3" name="error3[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div></div>'; //add input box
        }
        }	
            }
				...
				<hr style="height:2px;border-width:0;color:gray;background-color:gray">
 				...
 				<div class="form-group input_fields_wrap_1">
					<label class="control-label col-md-3.5 col-sm-3.5 col-xs-3.5" ><b>Industrial Knowledge</b></label>
                        ...
                        <div id="error1" name="error1[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div>
         ...
         
             {
              ...
              $('input[name="ict[]"]').each(function() {
                ...
                if($(this).val()=="")
                    ...
                    //  check=1;
                        check=1;
                        error+= "<p style=\"margin:0px;padding-bottom:0px;padding-top:0px;\">*Internship certificate is required.</p>";
