...
<div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 600px; background-image: url(../assets/img/theme/profile-cover.jpg); background-size: cover; background-position: center top;">
    ...
    <div class="card shadow">
        ...
        <div align="right"><button class='btn btn-outline-primary btn-lg submit' onclick="gotohomeadmin()">Home</button></div>
        <h3> Enter Company Ref No : </h3>        
        <form action="./mail-test.php" method="POST">
            <div class="input-box">
                
                <input name="company-ref" align="left" list=text_editors style="display: inline;"></input>
            ...
            <h3 style="display: inline; padding-right: 10px">Subject : </h3>
            <input name="mail-title"></input>
            
            <br><br>


            <textarea id="basic-example" name="mail-body" placeholder="Enter Email Body">
            </textarea>
            <input type="submit" name='Send Mail'></input>
        </form>
    </div>
</div>
...
<script>
    ...
    function gotohomeadmin(){
                  window.location.href ='../go-to-admin/admin';
                }
</script>
