...
//$primary_key="vatsal.pathak@somaiya.edu";
    
    {
        ...
        $out1="";
        $out2="";
        $q="select * from `pos_res` where Email='$primary_key'";
        ...
        if(mysqli_num_rows($qrun)>0){
            while($row1=mysqli_fetch_array($qrun))
            {
                ...
                $out1.='                   <div class="" style="margin-top:10px">   <br><hr align="left" class="col-md-7 col-sm-7 col-xs-7" style="height:2px;border-width:50%;color:gray;background-color:gray">         <div class="control-group input-group"><div class="col-md-8 col-sm-8 col-xs-8"><input value="'.$row1['dtl'].'" type="text" name="dtl[]" id="dtl" class=" form-control" ></div>&nbsp;&nbsp;&nbsp; </div>                         <div id="error11" name="error11[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div><br>                               <div class="control-group input-group">Year:<div class="col-md-3 col-sm-3 col-xs-3"> <input type="number" placeholder="2010" min=2000   required name="yrr[]" value="'.$row1['yrr'].'" id="yrr" class=" form-control" ></div>&nbsp;&nbsp;&nbsp;<button class="btn ovrdbtn btn-outline-danger remove_field_1" type="button"><i class="fa fa-minus" style="font-size:20px"></i></button> </div>                                            <div id="error1" name="error1[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div>                       </div>';
        ...
        if(mysqli_num_rows($qrun)>0){
            while($row2=mysqli_fetch_array($qrun)){
                ...
                $out2.='                <div class="col-md-9 col-sm-9 col-xs-9"><br><hr style="height:2px;border-width:50%;color:gray;background-color:gray"><div class="input-group control-group after-add-more"><label for="itp">Internship type:&nbsp</label>'.$tmp01.'</div><br><div class="input-group control-group after-add-more"><div class="col-md-6 col-sm-6 col-xs-6 "><input type="text" value="'.$row2['ittl'].'" name="ittl[]" id="ittl" class="form-control" placeholder="Organization name"></div><label for="itnw">No of weeks</label><div class="col-md-3 col-sm-3 col-xs-3 "><input type="number" name="itnw[]" value="'.$row2['itnw'].'" id="itnw" class="form-control" placeholder=00></div></div>                             <div class="input-group control-group after-add-more"><div class="col-md-6 col-sm-6 col-xs-6 "><div id="error2" name="error2[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div></div><div class="col-md-3 col-sm-3 col-xs-3 "><div id="error4" name="error4[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div></div></div>                            <br><div class="input-group control-group after-add-more"><div>From:<input type="date" value="'.$row2['itfrom'].'" name="itfrom[]" id="itfrom" class="form-control" > </div><div class="ml-3">To:<input type="date" value="'.$row2['itto'].'" name="itto[]" id="itto" class="form-control" > </div>                          </div>              <div class="input-group control-group after-add-more"><div class="" id="error5" name="error5[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div><div class="ml-9" id="error6" name="error6[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div></div> <br><div class="input-group control-group after-add-more">Upload Certificate:  &nbsp;<a href="viewfile.php?location='.getcwd().'/'.$row2['ict'].' "><input type="file" id="ict"  class="form-control" name="ict[]" hidden>                <input type="text" id="traverse"  class="form-control" value="'.$row2['ict'].'" name="traverse[]" hidden><button class="btn  btn-outline-primary " type="button">view file</button></a>&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn ovrdbtn btn-outline-danger remove_field_2" type="button"><i class="fa fa-minus" style="font-size:20px"></i></button></div><div id="error3" name="error3[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div></div>'; //add input box
          ...
          <form class="needs-validation cst-bclass" id ="qwerq" method="post" action="data_fetch.php" enctype="multipart/form-data" novalidate>
				...
				<hr style="height:2px;border-width:0;color:gray;background-color:gray">
 				...
 				<div class="form-group input_fields_wrap_1">
					<label class="control-label col-md-3.5 col-sm-3.5 col-xs-3.5" ><b>Positions and Responsibility Undertaken in KJSCE</b></label>
...
$(document).ready(function() {
	...
	$(add_button_1).click(function(e){ //on add input button click
		...
		if(x1 < max_fields_1){ //max input box allowed
			...
			$(wrapper_1).append('                    <div class="" style="margin-top:10px">   <br><hr align="left" class="col-md-7 col-sm-7 col-xs-7" style="height:2px;border-width:50%;color:gray;background-color:gray">        <div class="control-group input-group"><div class="col-md-8 col-sm-8 col-xs-8"><input type="text" name="dtl[]" id="dtl" class=" form-control" ></div>&nbsp;&nbsp;&nbsp; </div>                         <div id="error11" name="error11[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div><br>                               <div class="control-group input-group">Year:<div class="col-md-3 col-sm-3 col-xs-3"> <input type="number" placeholder="2010" min=2000   required name="yrr[]" id="yrr" class=" form-control" ></div>&nbsp;&nbsp;&nbsp;<button class="btn ovrdbtn btn-outline-danger remove_field_1" type="button"><i class="fa fa-minus" style="font-size:20px"></i></button> </div>                                            <div id="error1" name="error1[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div>                       </div>'); //add input box
		}
	});
	...
	$(add_button_2).click(function(e){ //on add input button click
		...
		if(x2 < max_fields_2){ //max input box allowed
			...
			$(wrapper_2).append('							<div class="col-md-9 col-sm-9 col-xs-9"><br><hr style="height:2px;border-width:50%;color:gray;background-color:gray"><div class="input-group control-group after-add-more"><label for="itp">Internship type:&nbsp;</label><select class="form-control" id="itp" class="itp" name="itp[]"><option value="In-House">In-House</option><option value="External">External</option></select></div><br><div class="input-group control-group after-add-more"><div class="col-md-6 col-sm-6 col-xs-6 "><input type="text" name="ittl[]" id="ittl" class="form-control" placeholder="Organization name"></div><label for="itnw">No of weeks</label><div class="col-md-3 col-sm-3 col-xs-3 "><input type="number" name="itnw[]" id="itnw" class="form-control" placeholder=00></div></div>                             <div class="input-group control-group after-add-more"><div class="col-md-6 col-sm-6 col-xs-6 "><div id="error2" name="error2[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div></div><div class="col-md-3 col-sm-3 col-xs-3 "><div id="error4" name="error4[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div></div></div>                            <br><div class="input-group control-group after-add-more"><div>From:<input type="date" name="itfrom[]" id="itfrom" class="form-control" > </div><div class="ml-3">To:<input type="date" name="itto[]" id="itto" class="form-control" > </div>                          </div>              <div class="input-group control-group after-add-more"><div class="" id="error5" name="error5[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div><div class="ml-9" id="error6" name="error6[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div></div> <br><div class="input-group control-group after-add-more">Upload Certificate:  &nbsp;<input type="file" id="ict"  name="ict[]" class="form-control" >&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="traverse"  class="form-control" value="traverse" name="traverse[]" hidden> <button class="btn ovrdbtn btn-outline-danger remove_field_2" type="button"><i class="fa fa-minus" style="font-size:20px"></i></button></div><div id="error3" name="error3[]" style="color:#f23a3a;padding-left:20px;" ><?php// echo $error2; ?></div></div>'); //add input box
		}
	});
