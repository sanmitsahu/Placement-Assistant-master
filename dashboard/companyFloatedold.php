    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
      ...
      <ul class="navbar-nav">
        <li class="nav-item  class=" active>
          <a class=" nav-link active " href=" ./index.php"> <i class="ni ni-collection text-primary"></i> Available
          </a>
        </li>
        <li class="nav-item">
            ...
            <div class="col-xl-12 order-xl-1">
              <div class="card bg-secondary shadow">
                <div class="container">
                  ...
                  $sql = "SELECT Company_name,Ref_no,Address,email_id,Announcement_date,Reg_deadline,primary_link,secondary_link FROM company_module";
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      $plink = "/Placement-Assistant-master/dashboard/2020/$companay_name/downloadme.html";
                      ...
                      <div onclick=\"myFunction('$companay_name','$email','$address','$Ann_date','$reg_deadline','$plink','$a')\" class=\"card\">
                        ...
                        <div class='form-container sign-up-container' align='right' >
                           ...
                           <input type='hidden' name='companyrefno' value='<?php echo $refno ?>' />
                           <input type='hidden' name='reg_deadline' value='<?php echo $regded ?>' />
                           <?php
