        ...
        <div class="col">
            <div class="card shadow">
                                    ...
                                    <form method="POST" action="verify.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group input-group-alternative mb-3">
                                                ...
                                                <textarea class="form-control" placeholder="Department id"
                                                    name="dept_id" required=""></textarea>
                                            </div>
                                        </div>
                ...
                ?>
                    ...
                    <table class="table align-items-center table-flush display" id="dept-table">
                    ...
                    while($row = mysqli_fetch_assoc($query_run)) 
                     ...
                     ?>
                            ...
                            <tr>
                                <th>
                                    <span class="mb-0 text-sm"><?php echo $row['department'];?></span>
                                </th>
                                <td>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <form action="update_subject.php" method="POST">
                                                <input type="hidden" name="updatesub"
                                                    ...
                                                    <input type="hidden" name="updatesubid"
                                                    value="<?php echo $row['sub_id'];?>">
                                                    <input type="hidden" name="updatedeptid"
                                                    value="<?php echo $row['dept_id'];?>">
                                                <!-- Button trigger modal -->
