...
<a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./index.php">Update Admin</a>
                 ...
                 ?>
                    <form method="POST" action="verify.php">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="" type="text" name="upusernamed"
                                value="<?php echo $row['username'];?>" disabled>
<input  type="hidden" name="upusername"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-alternative mb-3">
                                ...
                                <input class="form-control" placeholder="" type="text" name="upname"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-alternative mb-3">
                                ...
                                <input class="form-control" placeholder="" type="email" name="upmailid"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-alternative mb-3">
                                ...
                                <input class="form-control" placeholder="" type="tel" name="upcontact"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" placeholder="" type="password" name="uppassadmin"
