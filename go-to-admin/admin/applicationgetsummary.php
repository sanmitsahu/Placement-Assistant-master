...
if($searchByGender != ''){
 ...
 if($ref_no != ''){
    $searchQuery .= " and (personal.Email in (SELECT email_id FROM company_applied WHERE Ref_no='".$ref_no."')) ";
 }
// }SELECT * FROM personal where Email in (SELECT email_id FROM company_applied WHERE Ref_no ='1234XYZ')
