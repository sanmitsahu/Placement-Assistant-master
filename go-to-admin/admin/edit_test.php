...
<td><input type="hidden" name="test_id[]" class="txtField" value="<?php echo $row[$i]['test_id']; ?>"><input type="text" name="test_id[]" class="txtField" value="<?php echo $row[$i]['test_id']; ?>" readonly></td>
</tr>
<tr>
