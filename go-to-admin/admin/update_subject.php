          ...
          <div class="card shadow">
            <div class="card-header border-0">
                ...
                if (isset($_POST['updatesubject'])) {
                 ...
                 $upsubid = $_POST['updatesubid'];
                 $updeptid = $_POST['updatedeptid'];

                $query = "SELECT * FROM subject WHERE `sub_id` = '$upsubid' ";
                ...
                <div class="modal-footer">
 				...
 				<?php 
				  ...
				  echo '<h4> Successfully Updated !!!</h4>';
				   	   ?>
				   	 <a href="subject.php"><button type="button" class="btn btn-secondary" data-dismiss="modal">Back</button></a>	<?php 
