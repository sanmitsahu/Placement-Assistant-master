...
<div class="container-fluid mt--7">
        ...
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
					...
					<input type="hidden" name="type" value="aptitude"?>
                        <?php 
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-email">Aptitude</label>
                                        <select name="department" id="department" class="form-control  mb-3" disabled>
                                            <option value="10">
                                                Aptitude
                                            </option>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="sub" id="sub" class="form-control  mb-3">
                                            <option value="Choose" disabled selected>Choose SubType</option>

                                         <?php $sql="select distinct(subtype) from practice_questions where type='aptitude'";
										 $run=mysqli_query($connection,$sql);
										 while($r=mysqli_fetch_array($run)){
											 ?>
											 <option value="<?php echo $r['subtype']; ?>"><?php echo $r['subtype']; ?></option>
										 <?php } ?>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <input type="file" name="file" value="" id="file_prac"
 ...
 <div class="col-lg-6">
                            ...
                            <button type="submit" class="btn btn-outline-primary" name="submit_fileapti">Add</button>
