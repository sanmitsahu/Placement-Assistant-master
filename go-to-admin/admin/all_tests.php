...
<td><input type="radio" name="users[]" value="<?php echo $row["test_id"]; ?>" id="<?php echo $i; ?>" checked></td>
...
<td><?php echo $row["test_created"]; ?></td>
...
<tr class="listheader">	
<td colspan="4"><input type="button" name="update" id="update" value="Update" onClick="setUpdateAction();" /> <input type="button" name="delete" value="Delete"  onClick="setDeleteAction();" /></td>
</tr>
</label>
</div>
</form>
