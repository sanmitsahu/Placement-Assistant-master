...
<div class="container-fluid mt--7">
    ...
    <div class="col-lg-6">
    <label class="form-control-label" for="">Passing Marks</label>
                                <input type="text" class="form-control" name="minmarks" id="minmarks"
                                            placeholder="Minimum marks required to pass" required>
                                </div>

    <div class="col-lg-6">
    <label class="form-control-label" for="">Maximum attempts</label>
                                <input type="text" class="form-control" name="maxattempts" id="maxattempts"
                                            placeholder="Maximum number of times student can give test." required>
                                </div>							
