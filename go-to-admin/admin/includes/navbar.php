  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <!-- Brand -->
      <a class="navbar-brand pt-0" href="./student_manager.php">
 ...
 <!-- Navigation -->
        <ul class="navbar-nav">
           ...
           <li class="nav-item">
            <a class="nav-link " href="../../dashboard/mail-system.php">
              <i class="ni ni-single-02 text-yellow"></i> Reminder Mail
            </a>
          </li>
           <li class="nav-item">
            <a class="nav-link " href="./student_manager.php">
              <i class="ni ni ni-archive-2 text-blue"></i> Student Manager
            </a>
          </li>
          <li class="nav-item">
		  ...
		  <li class="nav-item">
            <a class="nav-link " href="./view_test_data.php">
              <i class="ni ni-bullet-list-67 text-red"></i> View Test Data
            </a>
          </li>
          <li class="nav-item">
