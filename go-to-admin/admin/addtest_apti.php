...
<div class="container-fluid mt--7">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
										...
										<input type="hidden" name="department" value="10">
                                        <select id="" name="department" class="form-control  mb-3" disabled>
                                        <option value="10">
                                                Aptitude
                                            </option>
                                        </select>
	...
	<label class="form-control-label" for="">Test name</label>
								<input type="text" class="form-control" name="test_name" id="test_name"
                                            placeholder="eg. area,alligation,numbers etc" required>
								</div>
	<div class="col-lg-6">
    ...
    <div class="col-lg-6">
    <label class="form-control-label" for="">Minimum Marks</label>
                                <input type="text" class="form-control" name="minmarks" id="minmarks"
                                            placeholder="Passing Marks" required>
                                </div>

    <div class="col-lg-6">
    <label class="form-control-label" for="">Maximum Attempts</label>
                                <input type="text" class="form-control" name="attempts" id="attempts"
                                            placeholder="Maximum attempts" required>
                                </div>
...
<div class="row">
        ...
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form action="verify.php" method="POST" enctype="multipart/form-data">
					<input type="hidden" value="aptitude" name="type">
                        <?php 
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="test_id" id="test_id" class="form-control  mb-3" required>
                                            ...
                                            <?php
											$t="select test_id from tests_data where test_created=0 and department=10";
